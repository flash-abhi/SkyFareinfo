    ...
    >
      <div className="header-container">
        ...
        <nav className={`nav ${mobileMenuOpen ? "nav-open" : ""}`}>
          ...
          <Link to="/flights" className="nav-link" onClick={closeMobileMenu}>
            Flights
          </Link>
          <Link to="/hotels" className="nav-link" onClick={closeMobileMenu}>
            Hotels
          </Link>
          <Link to="/cruises" className="nav-link" onClick={closeMobileMenu}>
            Cruises
          </Link>
          <Link to="/packages" className="nav-link" onClick={closeMobileMenu}>
            Packages
          </Link>
          <Link to="/airlines" className="nav-link" onClick={closeMobileMenu}>
            Airlines
          </Link>
        </nav>
