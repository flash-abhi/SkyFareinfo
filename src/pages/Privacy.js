      ...
      <div className="container">
        <div className="legal-content">
          <section>
            ...
            <p>At skyfareinfo.com, we collect the following types of information:</p>
            <ul>
          ...
          <section>
            ...
            <p>To exercise these rights, contact us at privacy@skyfareinfo.com</p>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>Email: privacy@skyfareinfo.com</li>
              <li>Phone: {contactSettings.tfn}</li>
              <li>Mail: Privacy Department, skyfareinfo.com</li>
            </ul>
          </section>
        </div>
      </div>
