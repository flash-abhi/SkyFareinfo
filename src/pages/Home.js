...
function Home() {
  ...
  return (
    <>
      <SeoMeta
        title="skyfareinfo.com - Best Flight & Travel Deals"
        description="Find the best flight deals, hotels, cruises and vacation packages at skyfareinfo.com. Book cheap flights and save on your next trip."
    ...
    <div className="home">
      <section className="hero">
        <div className="container">
          ...
          <p>Book flights, hotels, and packages to amazing destinations worldwide</p>
        </div>
      </section>
            ...
            <div className="search-card">
              ...
              {activeTab === 'flights' && (
                <>
                  ...
                  {/* Search Form */}
                  <form onSubmit={handleSearch} className="flight-search-form-new">
                      ...
                      <div className="search-row-details">
                        ...
                        {tripType === 'roundtrip' && (
                          <div className="input-group">
                            ...
                            <div className="input-content-dates">
                              <label className="input-label-small">Return</label>
                              <input
                                ref={returnDateRef}
                                type="date"
                                className="date-input-modern"
                        ...
                        <div className="input-group" ref={passengerDropdownRef}>
                          ...
                          <div className="input-content">
                            <label className="input-label-small">Travelers</label>
                            <div 
                              className="travelers-display"
                              onClick={() => setPassengerDropdown(!passengerDropdown)}
                            >
                              <span className="travelers-text">
                                {adult + child + infant} {adult + child + infant === 1 ? 'Traveler' : 'Travelers'}
                              </span>
                              <span className="travelers-class">{cabinClass === 'economy' ? 'Economy' : cabinClass === 'premium_economy' ? 'Premium' : cabinClass === 'business' ? 'Business' : 'First'}</span>
                            </div>
                          </div>
                          ...
                          {passengerDropdown && (
                            <div className="travelers-dropdown-new">
                              ...
                              <div className="travelers-list">
                                <div className="traveler-item">
                                  <div className="traveler-info-new">
                                    ...
                                    <span className="traveler-desc">18+ years</span>
                                  </div>
                                  <div className="traveler-counter">
                                    ...
                                    <button 
                                      type="button" 
                                      className="counter-btn"
                                      onClick={() => setAdult(Math.min(9, adult + 1))}
                                      disabled={adult >= 9}
                                    >+</button>
                                  </div>
                                </div>
                                ...
                                <div className="traveler-item">
                                  <div className="traveler-info-new">
                                    ...
                                    <span className="traveler-desc">0-17 years</span>
                                  </div>
                                  <div className="traveler-counter">
                                    <button 
                                      type="button" 
                                    ...
                                    <button 
                                      type="button" 
                                      className="counter-btn"
                                      onClick={() => setChild(Math.min(9, child + 1))}
                                      disabled={child >= 9}
                                    >+</button>
                                  </div>
                                </div>
                                ...
                                <div className="traveler-item">
                                  <div className="traveler-info-new">
                                    <span className="traveler-label">Infants</span>
                                    <span className="traveler-desc">Under 2 years</span>
                                  </div>
                                  <div className="traveler-counter">
                                    <button 
                                      type="button" 
                                    ...
                                    <button 
                                      type="button" 
                                      className="counter-btn"
                                      onClick={() => setInfant(Math.min(9, infant + 1))}
                                      disabled={infant >= 9}
                                    >+</button>
                                  </div>
                                </div>
                              ...
                              <div className="cabin-selector">
                                <label className="cabin-label-new">Cabin class</label>
                                <div className="cabin-options">
                                  {['economy', 'premium_economy', 'business', 'first'].map((cabin) => (
                                    ...
                                    >
                                      {cabin === 'economy' ? 'Economy' : cabin === 'premium_economy' ? 'Premium' : cabin === 'business' ? 'Business' : 'First'}
                                    </button>
                                  ))}
                                </div>
                              </div>
                    ...
                    <button type="submit" className="search-btn-new">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M19 19L14.65 14.65M17 9C17 13.4183 13.4183 17 9 17C4.58172 17 1 13.4183 1 9C1 4.58172 4.58172 1 9 1C13.4183 1 17 4.58172 17 9Z" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
                      </svg>
                      Search Flights
                    </button>
                  </form>
                ...
                <div className="search-fields">
                  ...
                  <div className="field-wrapper" ref={staysDropdownRef}>
                    ...
                    >
                      ...
                      <span>{staysAdults + staysChildren} traveler{(staysAdults + staysChildren) > 1 ? 's' : ''}, {staysRooms} room{staysRooms > 1 ? 's' : ''}</span>
                      ...
                      <div className="travelers-dropdown">
                        <div className="traveler-row">
                          ...
                          <div className="traveler-controls">
                            <button type="button" onClick={() => setStaysAdults(Math.max(1, staysAdults - 1))}>-</button>
                            <span>{staysAdults}</span>
                            <button type="button" onClick={() => setStaysAdults(Math.min(9, staysAdults + 1))}>+</button>
                          </div>
                        </div>
                        <div className="traveler-row">
                          <div className="traveler-info">
                          ...
                          <div className="traveler-controls">
                            <button type="button" onClick={() => setStaysChildren(Math.max(0, staysChildren - 1))}>-</button>
                            <span>{staysChildren}</span>
                            <button type="button" onClick={() => setStaysChildren(Math.min(9, staysChildren + 1))}>+</button>
                          </div>
                        </div>
                        <div className="traveler-row">
                          <div className="traveler-info">
                          ...
                          <div className="traveler-controls">
                            <button type="button" onClick={() => setStaysRooms(Math.max(1, staysRooms - 1))}>-</button>
                            <span>{staysRooms}</span>
                            <button type="button" onClick={() => setStaysRooms(Math.min(9, staysRooms + 1))}>+</button>
                          </div>
                        </div>
                      </div>
                    )}
              ...
              <div className="trip-options">
                <label className="radio-option">
                  <input type="radio" name="packageType" value="flight-hotel" defaultChecked />
                  <span>Flight + Hotel</span>
                </label>
                <label className="radio-option">
                  <input type="radio" name="packageType" value="flight-hotel-car" />
              ...
              <form onSubmit={handlePackagesSearch}>
                <div className="search-fields">
                  ...
                  {/* Swap Button */}
                  <button type="button" className="swap-btn" onClick={() => { const temp = packageFrom; setPackageFrom(packageTo); setPackageTo(temp); }}>
                    ⇄
                  </button>
                    ...
                    <div className="dates-fields">
                      <div className="field-input date-input">
                        ...
                        <input 
                          ...
                          onChange={(e) => setPackageDepartDate(e.target.value)}
                          placeholder="Depart" 
                          min={new Date().toISOString().split('T')[0]} 
                        />
                      </div>
                      ...
                      <div className="field-input date-input">
                        <input 
                          ...
                          onChange={(e) => setPackageReturnDate(e.target.value)}
                          placeholder="Return" 
                          min={packageDepartDate || new Date().toISOString().split('T')[0]} 
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="field-wrapper" ref={packagesDropdownRef}>
                    ...
                    >
                      <User size={18} className="field-icon" />
                      <span>{packagesAdults + packagesChildren} traveler{(packagesAdults + packagesChildren) > 1 ? 's' : ''}, {packagesRooms} room{packagesRooms > 1 ? 's' : ''}</span>
                      <span className="dropdown-icon">▼</span>
                    </div>
                    {packagesDropdown && (
                      <div className="travelers-dropdown">
                        <div className="traveler-row">
                          ...
                          <div className="traveler-controls">
                            <button type="button" onClick={() => setPackagesAdults(Math.max(1, packagesAdults - 1))}>-</button>
                            <span>{packagesAdults}</span>
                            <button type="button" onClick={() => setPackagesAdults(Math.min(9, packagesAdults + 1))}>+</button>
                          </div>
                        </div>
                        <div className="traveler-row">
                          <div className="traveler-info">
                          ...
                          <div className="traveler-controls">
                            <button type="button" onClick={() => setPackagesChildren(Math.max(0, packagesChildren - 1))}>-</button>
                            <span>{packagesChildren}</span>
                            <button type="button" onClick={() => setPackagesChildren(Math.min(9, packagesChildren + 1))}>+</button>
                          </div>
                        </div>
                        <div className="traveler-row">
                          <div className="traveler-info">
                          ...
                          <div className="traveler-controls">
                            <button type="button" onClick={() => setPackagesRooms(Math.max(1, packagesRooms - 1))}>-</button>
                            <span>{packagesRooms}</span>
                            <button type="button" onClick={() => setPackagesRooms(Math.min(9, packagesRooms + 1))}>+</button>
                          </div>
                        </div>
                      </div>
                    )}
      ...
      <section className="popular-routes-section">
        <div className="container">
          <div className="section-header">
            <h2><TrendingDown size={28} /> Popular Flight Deals</h2>
          ...
          {dealsLoading ? (
            ...
            <>
              ...
              <div className="routes-category">
                <h3><MapPin size={20} /> Domestic US Flights</h3>
                <div className="deals-grid">
                  {popularDeals.filter(d => d.type === 'domestic').map((deal, index) => (
                    <div 
                      key={index} 
                      className="deal-card"
                      onClick={() => navigate(`/flight-results?from=${deal.from}&to=${deal.to}&date=${deal.date}&tripType=oneway&passengers=1`)}
                    >
                      ...
                      <div className="deal-content">
                        ...
                        <div className="deal-details">
                          ...
                          <div className="deal-duration">
                            {deal.duration?.replace('PT', '').replace('H', 'h ').replace('M', 'm')}
                        ...
                        <div className="deal-price-row">
                          <div className="deal-price">
                            ...
                            <span className="price-amount">${Math.round(deal.price)}</span>
                          </div>
                          <button className="deal-book-btn">View Deal</button>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              {/* International Routes */}
              <div className="routes-category">
                <h3><Plane size={20} /> International Flights</h3>
                <div className="deals-grid">
                  {popularDeals.filter(d => d.type === 'international').map((deal, index) => (
                    <div 
                      key={index} 
                    ...
                    >
                      <div className="deal-image" style={{ backgroundImage: `url(${deal.image})` }}>
                        <div className="deal-badge international">International</div>
                      </div>
                      <div className="deal-content">
                        <div className="deal-route">
                          <span className="deal-city">{deal.fromCity}</span>
