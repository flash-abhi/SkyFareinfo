...
class BlogPublisherService {
  ...
  async publishToMedium(blogPost) {
    ...
    const response = await axios.post(
      `https://api.medium.com/v1/users/${userId}/posts`,
      {
        ...
        canonicalUrl: `https://skyfareinfo.com/blog/${blogPost.slug}`
      },
      {
        headers: {
    ...
    const response = await axios.post(
      'https://dev.to/api/articles',
      {
        article: {
          ...
          canonical_url: `https://skyfareinfo.com/blog/${blogPost.slug}`,
  ...
  convertToMediumFormat(content) {
    ...
    return content + '\n\n---\n\n*Originally published at [skyfareinfo.com](https://skyfareinfo.com)*';
  }
        ...
        platforms: [
          {
            ...
            instructions: 'Copy content and paste. Add canonical URL to skyfareinfo.com',
            canonicalUrl: `https://skyfareinfo.com/blog/${blogPost.slug}`
          },
          {
            name: 'Dev.to',
          ...
          },
          {
            ...
            instructions: 'Write article, paste content, link back to skyfareinfo.com'
          },
          {
            name: 'Hashnode',
            da: 88,
